...
export default function Illustrations({ illustrations }) {
  const illustrationsElements = illustrations.map((illustrations) => {
    console.log(illustrations.fields.slug);
    return (
      <BookPreview
        key={illustrations.sys.id}
        width={illustrations.fields.animation.fields.file.details.image.width}
        height={illustrations.fields.animation.fields.file.details.image.height}
