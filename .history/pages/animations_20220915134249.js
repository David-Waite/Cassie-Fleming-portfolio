      ...
      <div className={styles.layout} key={i}>
        <div>
          <BookPreview
            ...
            width={animations[i].fields.image.fields.file.details.image.width}
            height={animations[i].fields.image.fields.file.details.image.height}
            src={animations[i].fields.image.fields.file.url}
            alt={animations[i].fields.title}
          />
          {l ? (
            <BookPreview
              key={animations[l].sys.id}
              width={animations[l].fields.image.fields.file.details.image.width}
              height={
                animations[l].fields.image.fields.file.details.image.height
              }
              src={animations[l].fields.image.fields.file.url}
