        ...
        <div className={styles.model}>
          <div className={styles.modelContent}>
            ...
            <p className={styles.text}>
              ...
              mollitia animi, veritatis quaerat fugiat repellat. Veritatis
              iusto, illum nemo quis perspiciatis ipsam architecto enim maiores
              deleniti eum ab eos neque recusandae corrupti animi! Voluptates
              soluta quia nobis, pariatur aut eveniet. lor
            </p>
          </div>
        </div>
      </div>
