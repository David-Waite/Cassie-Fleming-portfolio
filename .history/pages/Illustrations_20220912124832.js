      ...
      <div className={styles.modal}>
        ...
        <div className={styles.text}>
          ...
          <p className={styles.description}>
            ...
            exercitationpsoefposafkpoasdfkaspfoksa[pdfkosa[dpfoskadf[posakdf[psaokdf[psaokdfsa[pdofkasljdfnsiem
            temporibus dicta amet fuga tenetur repudiandae reiciendis quod
            voluptatibus. Deserunt officia illum sapiente impedit doloremque in,
            ipsum natus molestiae, iusto, id ipsam doloribus praesentium
            officiis sint dolorem harum! Consectetur, aspernatur numquam
          </p>
        </div>
      </div>
      <div>
