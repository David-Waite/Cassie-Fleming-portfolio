  ...
  return (
    <div className={styles.layout}>
      ...
      <p className={styles.aboutText}>
        ...
        Swinburne University of technology. I specialize in 2D animation (Toon
        Boom Harmony) with experience in illustrating children's books,
        designing characters to match brands and worked as the lead animator on
        a short student film called 'A Light Touch'. Hi!
        <br />
        <br />
