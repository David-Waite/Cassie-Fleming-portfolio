  ...
  const animationsElements = animations.map((animation) => {
    return (
      <BookPreview
        ...
        width={animation.fields.image.fields.file.details.image.width}
        height={animation.fields.image.fields.file.details.image.height}
        src={animation.fields.image.fields.file.url}
