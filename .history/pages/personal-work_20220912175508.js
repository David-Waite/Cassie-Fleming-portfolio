  ...
  for (let i = 0; i < personalWorks.length; i++) {
    ...
    personalWorksElementsv2 += (
      <div>
        ...
        />
        <BookPreview
          key={personalWorks[iv2].sys.id}
          width={
            personalWorks[iv2].fields.image.fields.file.details.image.width
          }
          height={
            personalWorks[iv2].fields.image.fields.file.details.image.height
          }
          src={personalWorks[iv2].fields.image.fields.file.url}
          alt={personalWorks[iv2].fields.title}
          slug={`/personalWorks/${personalWorks[iv2].fields.slug}`}
        />
      </div>
    );
    i++;
