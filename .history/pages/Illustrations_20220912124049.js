      ...
      <div className={styles.modal}>
        <div>
          ...
          <p className="description">
            ...
            cumque aliquam quam dolor officia, enim ratione ex vel, dolores
            exercitationem temporibus dicta amet fuga tenetur repudiandae
            reiciendis quod voluptatibus. Deserunt officia illum sapiente
            impedit doloremque in, ipsum natus molestiae, iusto, id ipsam
            doloribus praesentium officiis sint dolorem harum! Consectetur,
            aspernatur numquam laudantium distinctio nulla inventore, libero
            porro voluptatibus exercitationem reprehenderit dolor ab dolore
            facere laboriosam doloribus? Earum, laboriosam velit, provident
            culpa ut animi dolores consequatur id, neque minus ex accusantium
            tempora?
          </p>
        </div>
      </div>
