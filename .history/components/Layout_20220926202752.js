...
export default function Layout({ children }) {
  ...
  const [duckImage, setDuckImage] = useState("/duckBlinking.gif");
  ...
  function duckClick() {
    setTimeout(() => {
      setDuckImage("/duckBlinking.gif");
    }, [1917]);
    setDuckImage("/duckQuacking.gif");
  }
  return (
    <div>
      <div className={`layout ${navState.navClass}`}>
        ...
        <footer>
          ...
          <div>
            <img onClick={duckClick} className="duck" src={duckImage} alt="" />
            <img className="quack" src="/quack.png" alt="" />
          </div>
        </footer>
      </div>
    </div>
