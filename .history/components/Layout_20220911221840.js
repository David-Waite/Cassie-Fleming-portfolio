  ...
  return (
    <div className={`layout ${navClass}`}>
      <header className="header">
        ...
        <nav>
          <Link href="/">
            <a className={currentRoute === "/" ? "active" : ""}>About</a>
          </Link>
          <Link href="/">
            <a className={currentRoute === "/animations" ? "active" : ""}>
              Animations
            </a>
          </Link>
          <Link href="/illustrations">
            <a className={currentRoute === "/illustrations" ? "active" : ""}>
              Illustrations
            </a>
          </Link>
          <Link href="/">
            <a className={currentRoute === "/showreel" ? "active" : ""}>
              Showreel
            </a>
          </Link>
        </nav>
      ...
      <h2> {currentRoute === "/illustrations" ? "active" : "non-active"}</h2>
